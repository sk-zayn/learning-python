...
# max = 25
# maximum_number = 25*6
# sub1 = int (input("enter the marks of sub 1 0-25 "))
# sub2 = int (input("enter the marks of sub 2 0-25 "))
# sub3 = int (input("enter the marks of sub 3 0-25 "))
# sub4 = int (input("enter the marks of sub 4 0-25 "))
